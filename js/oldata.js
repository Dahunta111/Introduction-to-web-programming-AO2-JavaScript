...
function updateForm(formName, formID, arrayPosition) {
    //clear Content
    clearContent();
    //form update Controls
    formControl(formName, formID, arrayPosition);
...
function formControl(formName, formID, arrayPosition) {

    if (
        formName == "wifiPower" && document.getElementById(formID).checked == true ||
        formName == "petsAllowed" && document.getElementById(formID).checked == true ||
        formName == "swimming" && document.getElementById(formID).checked == true) {

        conditions[arrayPosition] = true;

    } else if (
        formName == "wifiPower" && document.getElementById(formID).checked == false ||
        formName == "petsAllowed" && document.getElementById(formID).checked == false ||
        formName == "swimming" && document.getElementById(formID).checked == false) {

        conditions[arrayPosition] = false;

    } else {
        conditions[arrayPosition] = parseFloat(document.getElementById(formID).value);
    }
}
